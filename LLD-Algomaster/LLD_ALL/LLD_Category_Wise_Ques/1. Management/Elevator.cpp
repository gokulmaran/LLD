...
External requests (Up/Down buttons)
...
public:
    ...
    Request(int f, Direction d, bool internal)
        : floor(f), direction(d),
          isInternal(internal) {}
};
...
int main() {
    ...
    ElevatorController controller(2);
